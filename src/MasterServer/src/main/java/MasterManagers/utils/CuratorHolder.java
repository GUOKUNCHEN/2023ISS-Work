...
public class CuratorHolder {
	...
	public CuratorHolder() {
		System.out.println("采用默认方式构造CuratorHolder,ZK_Host为:"+ZookeeperManager.ZK_HOST);
		this.hostUrl = ZookeeperManager.ZK_HOST;
		setUpConnection(hostUrl);
	}

    public CuratorHolder(String hostUrl) {
		// System.out.println(("hostUrl为:"+hostUrl));
